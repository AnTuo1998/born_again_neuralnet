...
class ResNet(nn.Module):
    ...
    Args:
        ...
        ...
        multiple_branch (bool): has multiple branches or not, default = True,
        if multiple_branch = false, the model equals to ResNet
    """
    ...
    def _forward_impl(self, x: Tensor, is_feat: bool = False) -> Tuple[Tensor]:
